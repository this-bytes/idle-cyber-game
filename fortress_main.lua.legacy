...
function love.load()
    ...
    love.window.setTitle("🏰 Cyber Empire Command - Fortress Edition")
    ...
    if success then
        print("🏰 Fortress Edition loaded successfully!")
    else
        print("❌ Failed to initialize Fortress Edition")
    end
end
...
function love.quit()
    ...
    print("🏰 Fortress Edition shutdown complete. Thanks for playing!")
end