...
function GameMechanicsTest:setUp()
    ...
    self.systems.contractSystem = ContractSystem.new(self.eventBus, self.systems.dataManager, self.systems.resourceManager, self.systems.upgradeSystem, self.systems.specialistSystem)
